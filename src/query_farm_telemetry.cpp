...
namespace duckdb
{
  ...
  INTERNAL_FUNC void QueryFarmSendTelemetry(ExtensionLoader &loader, shared_ptr<DatabaseInstance> db, const string &extension_name, const string &extension_version)
  {
